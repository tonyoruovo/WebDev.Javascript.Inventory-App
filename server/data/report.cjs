 ...
 */
/**
 * The location of the subject of this report as well as any relevant parameters.
 * @typedef {Object} ReportParam Note that there may be other parameters attached to this object, but the properties specified
 * here are essential.
